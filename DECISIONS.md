...
- **Revisit:** If a later build adds a network call, a notification permission request, an account screen, or a clear animation, rewrite the criteria to name that rig. If a playtest shows one of the eight statements is not what the player experiences, amend the statement and reset that requirement's verification.
- **Outcome:** _(filled at review)_
